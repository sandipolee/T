...
export default function Dashboard({
  ...
  return (
    <div className="flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${isCollapsed ? 'ml-[5%]' : 'ml-[15%]'}`}>
        <div className={`fixed top-0 right-0 z-10 bg-background transition-all duration-300 ${isCollapsed ? 'w-[95%]' : 'w-[85%]'}`}>
          <DashboardHeader />
        </div>
